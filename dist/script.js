...
/* harmony import */ var _modules_hoverImg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/hoverImg */ "./src/js/modules/hoverImg.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"])('.main-slider-item', 'vertical');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
  ...
  Object(_modules_hoverImg__WEBPACK_IMPORTED_MODULE_8__["default"])('.size-1');
  Object(_modules_hoverImg__WEBPACK_IMPORTED_MODULE_8__["default"])('.size-2');
  Object(_modules_hoverImg__WEBPACK_IMPORTED_MODULE_8__["default"])('.size-3');
  Object(_modules_hoverImg__WEBPACK_IMPORTED_MODULE_8__["default"])('.size-4');
...
var accordion = function accordion() {
  function bindAccordion(targetSelectors, contentSelectors) {
    var targets = document.querySelectorAll(targetSelectors),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(sizeSelector, materialSelector, servicesSelector, promoSelector, priceBlockSelector) {
...
var filter = function filter() {
  ...
  var filter = function filter(mark) {
    var content = wrapper.querySelectorAll(".".concat(mark));
    ...
    noSelectors.forEach(function (item) {
      if (item == mark) {
...
/* harmony import */ var _services_request__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/request */ "./src/js/modules/services/request.js");
...
var forms = function forms() {
  ...
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var itemHeight = getComputedStyle(item, null).height;
      ...
      Object(_services_request__WEBPACK_IMPORTED_MODULE_6__["postData"])('assets/server.php', formData).then(function () {
        ...
        setTimeout(function () {
          ...
          chooseFile.forEach(function (item) {
  ...
  upload.forEach(function (item, index) {
    item.addEventListener('input', function () {
      var fullFileName = item.files[0].name,
...
var hoverImg = function hoverImg(selector) {
  var path = "assets/img/",
  ...
  var hoverFile = "".concat(path).concat(fileName, "-1.").concat(fileExtension);
...
var modal = function modal() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        scrollWith = Object(_calcScrollWidth__WEBPACK_IMPORTED_MODULE_1__["default"])();
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.marginRight = "".concat(scrollWith, "px");
  ...
  function showModalByTime(selector) {
    ...
    setTimeout(function () {
      ...
      if (!display && !btnPressed) {
        ...
        document.body.style.overflow = "hidden";
        var scroll = Object(_calcScrollWidth__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
/***/ "./src/js/modules/services/request.js":
/*!********************************************!*\
  !*** ./src/js/modules/services/request.js ***!
  \********************************************/
/*! exports provided: postData, getRequest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _services_request__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/request */ "./src/js/modules/services/request.js");
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    ...
    Object(_services_request__WEBPACK_IMPORTED_MODULE_3__["getRequest"])('assets/db.json').then(function (res) {
      createCard(res.styles);

      _this.remove();
    }).catch(function (e) {
      var er = document.querySelector('.popup-error');
...
var slider = function slider(slides, dir) {
  ...
  var autoAnimation = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
  var items = document.querySelectorAll(slides);
  var slideIndex = 0; //main dir className should be on 0 index
...
var smoothScroll = function smoothScroll(upSelector) {
  var upElem = document.querySelector(upSelector);
  window.addEventListener('scroll', function () {
    if (document.documentElement.scrollTop > 1650) {
      upElem.style.opacity = "0.9";
    } else {
